...
def list_transactions(
    ...
    q: str | None = Query(default=None, description="Search merchant/category/clean description"),
    normalized_type: str | None = Query(default=None, description="Filter by normalized type"),
