				...
				{!isSuccess ? (
					<form className="registration-form" onSubmit={handleSubmit} noValidate>
						...
						<label>
							...
							/>
							{errors.occupation ? <span className="field-error">{errors.occupation}</span> : null}
						</label>
						...
						<label>
							...
							{errors.primaryFinancialGoal ? (
								<span className="field-error">{errors.primaryFinancialGoal}</span>
							) : null}
						</label>
					...
					<section className="success-panel">
						...
						<p className="success-subtitle">Ready to Upload Your First Bank Statement</p>
